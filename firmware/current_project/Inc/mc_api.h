...
/* Returns the last computed raw observer mechanical speed for Motor 1, expressed in the unit defined by #SPEED_UNIT */
int16_t MC_GetRawMecSpeedAverageMotor1(void);

/* Returns the last computed raw observer mechanical speed for Motor 1, expressed in rpm */
float MC_GetRawMecSpeedAverageMotor1_F(void);

/* Returns the last computed filtered mechanical speed for Motor 1, expressed in the unit defined by #SPEED_UNIT */
int16_t MC_GetFilteredMecSpeedAverageMotor1(void);

/* Returns the last computed filtered mechanical speed for Motor 1, expressed in rpm */
float MC_GetFilteredMecSpeedAverageMotor1_F(void);
...
/* returns the current power of Motor 1 in int16_t format */
int16_t MC_GetAveragePowerMotor1(void);
