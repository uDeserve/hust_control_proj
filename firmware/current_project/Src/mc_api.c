...
/**
 * @brief Returns the last computed raw observer mechanical rotor speed for Motor 1, expressed in the unit defined by #SPEED_UNIT
 */
__weak int16_t MC_GetRawMecSpeedAverageMotor1(void)
{
	return MC_SPEED_GetRawSpeedUnit();
}

/**
 * @brief Returns the last computed raw observer mechanical rotor speed for Motor 1, expressed in rpm.
 */
__weak float MC_GetRawMecSpeedAverageMotor1_F(void)
{
	return (float)MC_SPEED_GetRawSpeedRpm();
}

/**
 * @brief Returns the last computed filtered mechanical rotor speed for Motor 1, expressed in the unit defined by #SPEED_UNIT
 */
__weak int16_t MC_GetFilteredMecSpeedAverageMotor1(void)
{
	return MC_SPEED_GetFilteredSpeedUnit();
}

/**
 * @brief Returns the last computed filtered mechanical rotor speed for Motor 1, expressed in rpm.
 */
__weak float MC_GetFilteredMecSpeedAverageMotor1_F(void)
{
	return (float)MC_SPEED_GetFilteredSpeedRpm();
}
 ...
 *        expressed in watt for Motor 1. Average is done over the last
 *        128 measured values at Medium Frequency Task rate.
 * @retval int16_t The average measured motor power expressed in watt.
 */
__weak int16_t MC_GetAveragePowerMotor1(void)
{
	return MPM_GetAvrgElMotorPowerW((MotorPowMeas_Handle_t *)pMPM[M1]);
}
...
*         float format of integer value.
 */
__weak float MC_GetAveragePowerMotor1_F(void)
{
	return ((float)MPM_GetAvrgElMotorPowerW((MotorPowMeas_Handle_t *)pMPM[M1]));
}
